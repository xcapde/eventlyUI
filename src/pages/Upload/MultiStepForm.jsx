...
export const MultiStepForm = ({ event, postEvent, updateEvent, addDirection, addWebUrl, eventDirection, uploadImg, deleteImg }) => {
    ...
    const forms = [
        ...
        },
        {
            ...
            view: <PlusForm event={event} uploadImg={uploadImg} deleteImg={deleteImg}/>
        },
    ]
